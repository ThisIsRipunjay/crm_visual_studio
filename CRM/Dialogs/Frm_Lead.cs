//Code Generated by Jenga.NET
			...
			{
			private CRM.Models.Lead _record;
			private CRM.Models.Lead _oldRecord;
            public Dictionary<string, object> FixedValues = new Dictionary<string, object>();

            public Func<CRM.Models.Lead, CRM.Models.Lead, bool> BeforeSave { get; set; } = null;
            public Action<CRM.Models.Lead> AfterSave { get; set; } = null;

			public Frm_Lead(Color themeColor,CRM.Models.Lead record = null, bool readOnly = false)
			{
			...
			if(record==null)
			_record = new CRM.Models.Lead(); //create new recoded
			else
			_record = record; //assign existing record

			//bind data to dropdowns
			var db = Kt.Db;
			cmbAssignedTo.DataSource=db.Select<CRM.Models.Member>();
//reference
            ...
            catch (Exception err)
            {
			  ...
			  private void Frm_Load(object sender, EventArgs e) 
			  {
					...
					if (this.FixedValues.Count() > 0)
					{
						...
						_record = tmp.ToObject<CRM.Models.Lead>();
					}
