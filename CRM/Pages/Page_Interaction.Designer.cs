//Code Generated by Jenga.NET
			...
			namespace CRM.Pages
			{
			partial class Page_Interaction
			{
			...
			this.column_Subject = new System.Windows.Forms.DataGridViewLinkColumn();
...
this.column_Attachment = new System.Windows.Forms.DataGridViewLinkColumn();
//init
			this.SuspendLayout();
			...
			this.colAvatar,
			column_Subject,column_Date,column_Type,column_Attachment,
			this.ColEdit,
			this.colDel});
			...
			// colAvatar
			//
			this.colAvatar.DataPropertyName = "Avatar(@Subject)";
            ...
            this.colAvatar.FillWeight = 30F;
                                    ...
                                    this.column_Subject.FillWeight = 200F;
                                    this.column_Subject.DataPropertyName = "Subject";
                                    ...
                                    this.cmbFilterType.Items.AddRange(new object[] { "Type (All)","Call","Email","Physical-Meeting","Video-Confrence"   });
                                    ...
                                    // column_Attachment
                                    //
                                    this.column_Attachment.HeaderText = "Attachment";
                                    this.column_Attachment.Name = "column_Attachment";
                                    this.column_Attachment.Text = "Open File";
                                    this.column_Attachment.UseColumnTextForLinkValue = true;
                                    //code
			...
			this.Name = "Page_Interaction";
			this.Size = new System.Drawing.Size(885, 703);
			this.Load += new System.EventHandler(this.Page_Interaction_Load);
          ...
          public Dictionary<string, Action<CRM.Models.Interaction>> ActionButtons = new Dictionary<string, Action<CRM.Models.Interaction>>();
          public Dictionary<string, Func<CRM.Models.Interaction , bool>> ActionButtonsFilter = new Dictionary<string, Func<CRM.Models.Interaction , bool>>();
            ...
            public Bunifu.UI.WinForms.BunifuSnackbar Alert;
			 public System.Windows.Forms.DataGridViewLinkColumn column_Subject;
public System.Windows.Forms.DataGridViewTextBoxColumn column_Date;
 public Bunifu.UI.WinForms.BunifuDropdown cmbFilterType;public System.Windows.Forms.DataGridViewTextBoxColumn column_Type;
public System.Windows.Forms.DataGridViewLinkColumn column_Attachment;
//declare
